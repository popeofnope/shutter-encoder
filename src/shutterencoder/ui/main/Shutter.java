...
import shutterencoder.functions.AudioEncoders;
import shutterencoder.functions.AudioNormalization;
import shutterencoder.functions.AudioSeparation;
import shutterencoder.functions.BackgroundRemover;
import shutterencoder.functions.BlackDetection;
import shutterencoder.functions.BlurFaces;
import shutterencoder.functions.Colorize;
import shutterencoder.functions.Command;
import shutterencoder.functions.Conform;
import shutterencoder.functions.DVDRIP;
import shutterencoder.functions.Extract;
import shutterencoder.functions.FrameMD5;
import shutterencoder.functions.LoudnessTruePeak;
import shutterencoder.functions.Merge;
import shutterencoder.functions.OfflineDetection;
import shutterencoder.functions.Picture;
import shutterencoder.functions.ReplaceAudio;
import shutterencoder.functions.Rewrap;
import shutterencoder.functions.Transcribe;
import shutterencoder.functions.Translate;
import shutterencoder.functions.VMAF;
...
import shutterencoder.library.DEMUCS;
...
import shutterencoder.ui.handlers.DestinationFileTransferHandler;
import shutterencoder.ui.handlers.GlobalKeyListener;
...
import shutterencoder.ui.others.HashGenerator;
import shutterencoder.ui.others.Informations;
import shutterencoder.ui.others.ManageFunctions;
import shutterencoder.ui.others.RecordInputDevice;
import shutterencoder.ui.others.ReducedWindow;
...
import shutterencoder.ui.others.Update;
import shutterencoder.ui.others.VideoWeb;
import shutterencoder.ui.renderers.AntiAliasedRoundRectangle;
import shutterencoder.ui.renderers.CollapsiblePanel;
import shutterencoder.ui.renderers.ComboBoxRenderer;
import shutterencoder.ui.renderers.ComboRenderer;
...
public class Shutter {
	...
	public static boolean subtitlesBurn = true;
	...
	protected static ImageIcon mailIcon;
	protected static ImageIcon streamIcon;
	...
	public static JCheckBox caseChangeFolder2;
	public static JCheckBox caseChangeFolder3;
	public static JCheckBox casePrefix;
	public static JTextField txtPrefix;
	public static JCheckBox btnExtension;
	public static JTextField txtExtension;
	public static JCheckBox caseSubFolder;
	public static JTextField txtSubFolder;
	public static JCheckBox caseDeleteSourceFile;
	public static JCheckBox caseRunInBackground;
	public static JCheckBox caseDisplay;
	protected static JLabel iconTVInterpret;
	public static JLabel iconList;
	public static JLabel iconPresets;
	public static JComboBox<String> comboResolution;
	protected static JLabel lblImageQuality;
	protected static JComboBox<String> comboImageOption;
	public static JCheckBox caseRotate;
	public static JComboBox<String> comboRotate;
	public static JCheckBox caseMiror;
	public static JCheckBox btnNoUpscale;
	...
	public static JCheckBox case2pass;
	...
	public static JCheckBox caseSetTimecode;
	public static JCheckBox caseIncrementTimecode;
	...
	public static JTextField TCset1;
	public static JTextField TCset2;
	public static JTextField TCset3;
	public static JTextField TCset4;
	protected static JCheckBox caseNormalizeAudio;
	public static JCheckBox caseEqualizer;
	protected static JCheckBox caseChangeAudioCodec;
	public static JCheckBox caseAudioOffset;
	...
	public static JComboBox<String> comboAccel;
	...
	public static JCheckBox caseForcerDAR;
	...
	public static JCheckBox caseOPATOM;
	...
	public static JTextField txtAudioOffset;
	...
	public static JLabel lblFilesEnded;
	public static JLabel lblFiles;
	protected static JLabel lblFilter;
	public static JTextField lblDestination1;
	...
	public static JCheckBox caseSendMail;
	...
	public Shutter() {		
		...
		if (desktop.isSupported(Desktop.Action.APP_ABOUT)) {
			desktop.setAboutHandler(e -> {
				...
				Image logo = new ImageIcon(getClass().getClassLoader().getResource("resources/icon.png")).getImage();
		...
		soundURL = this.getClass().getClassLoader().getResource("resources/complete.wav");
		soundErrorURL = this.getClass().getClassLoader().getResource("resources/error.wav");
		...
		// Global hardware listeners
		HardwareListener.keyboardListener();
		HardwareListener.mouseListener();
	...
	private void topBar() {
		...
		settingsIcon.addMouseListener(new MouseListener() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				settingsIcon.setIcon(new FlatSVGIcon("resources/settings.svg", 13, 13).setColorFilter(new FlatSVGIcon.ColorFilter(color -> {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				settingsIcon.setIcon(new FlatSVGIcon("resources/settings.svg", 13, 13));
				accept = false;
			}
		...
		help.addMouseListener(new MouseListener() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				help.setIcon(new FlatSVGIcon("resources/help.svg", 15, 15).setColorFilter(new FlatSVGIcon.ColorFilter(color -> {
				    float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
				    float newBrightness = Math.min(1.0f, hsb[2] * 0.9f); 				    
				    return Color.getHSBColor(hsb[0], hsb[1], newBrightness);
				})));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				help.setIcon(new FlatSVGIcon("resources/help.svg", 15, 15));
				accept = false;
			}
		...
		newInstance.addMouseListener(new MouseListener() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				newInstance.setIcon(new FlatSVGIcon("resources/new.svg", 15, 15).setColorFilter(new FlatSVGIcon.ColorFilter(color -> {
				    float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
				    float newBrightness = Math.min(1.0f, hsb[2] * 0.9f); 				    
				    return Color.getHSBColor(hsb[0], hsb[1], newBrightness);
				})));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				newInstance.setIcon(new FlatSVGIcon("resources/new.svg", 15, 15));
				accept = false;
			}
	...
	private void grpChooseFunction() {
		...
		iconList.addMouseListener(new MouseListener() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				iconList.setIcon(new FlatSVGIcon("resources/list.svg", 15, 15).setColorFilter(new FlatSVGIcon.ColorFilter(color -> {
				    float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
				    float newBrightness = Math.min(1.0f, hsb[2] * 0.9f); 				    
				    return Color.getHSBColor(hsb[0], hsb[1], newBrightness);
				})));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				iconList.setIcon(new FlatSVGIcon("resources/list.svg", 15, 15));
				accept = false;
			}
		...
		iconPresets.addMouseListener(new MouseListener() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				iconPresets.setIcon(new FlatSVGIcon("resources/presets.svg", 15, 15).setColorFilter(new FlatSVGIcon.ColorFilter(color -> {
				    float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
				    float newBrightness = Math.min(1.0f, hsb[2] * 0.9f); 				    
				    return Color.getHSBColor(hsb[0], hsb[1], newBrightness);
				})));
			...
			public void mouseReleased(MouseEvent e) {
				...
				if (accept) {
					...
					iconPresets.setIcon(new FlatSVGIcon("resources/presets.svg", 15, 15));
					...
					if (comboFonctions.getEditor().getItem().toString().contains("ffmpeg")) {
						...
						if (scan.getText().equals(language.getProperty("menuItemStopScan")) && scanIsRunning == false) {
							...
							else if (language.getProperty("functionBackgroundRemover").equals(function))
							{
								...
								URL sourceFile = getClass().getResource("/resources/avid.png");
								...
								case 1:
									FFMPEG.mseSensibility = 150f;
									sourceFile = getClass().getResource("/resources/davinci.png");
									break;
								case 2:
									FFMPEG.mseSensibility = 800f;
									sourceFile = getClass().getResource("/resources/premiere.png");
									break;
								case 3:
									FFMPEG.mseSensibility = 800f;
	...
	private void grpDestination() {
		...
		// Destinations icons
		mailIcon = new FlatSVGIcon("resources/mail.svg", 18, 18);
		streamIcon = new FlatSVGIcon("resources/stream.svg", 18, 18);

		// Ajout des tabs
		UIController.setDestinationTabs(5);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (caseDeleteSourceFile.isSelected()) {
					...
					if (reply == JOptionPane.NO_OPTION) {
						...
						caseDeleteSourceFile.setForeground(Utils.red);
				} else {
					caseDeleteSourceFile.setForeground(caseSubFolder.getForeground());
				}
	...
	private void grpProgress() {
		...
		progressBar.setBounds(6, 42, 300, 14);
				...
				if (System.getProperty("os.name").contains("Windows") && Taskbar.isTaskbarSupported()) {
					...
					if (progressBar.getValue() > 0)
						Taskbar.getTaskbar().setWindowProgressValue(frame,
								(100 * progressBar.getValue()) / progressBar.getMaximum());
					else
	...
	private void grpResolution() {
		...
		iconTVInterpret = new JLabel(new FlatSVGIcon("resources/preview.svg", 16, 16));
		...
		iconTVInterpret.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				iconTVInterpret.setIcon(new FlatSVGIcon("resources/preview.svg", 16, 16).setColorFilter(new FlatSVGIcon.ColorFilter(color -> {
				    float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
				    float newBrightness = Math.min(1.0f, hsb[2] * 1.1f); 				    
				    return Color.getHSBColor(hsb[0], hsb[1], newBrightness);
				})));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				iconTVInterpret.setIcon(new FlatSVGIcon("resources/preview.svg", 16, 16));
				frame.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
			}
		...
		lblScreenshot = new JLabel(new FlatSVGIcon("resources/screenshot.svg", 16, 16));
	...
	private void grpImageFilter() {
		...
		grpImageFilter.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpImageFilter, 122);
			}
	...
	private void grpSetTimecode() {
		...
		grpSetTimecode.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpSetTimecode, 117);
			}
	...
	private void grpSetAudio() {
		...
		grpSetAudio.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpSetAudio, size);
			}
				...
				if (lblAudioMapping.isFocusOwner())
				{
					if (lblAudioMapping.getSelectedItem().toString().equals("Multi"))
					{
						...
						if (grpSetAudio.getHeight() != 169)
							UIController.extendSections(grpSetAudio, 169);
						
					}
					else if (lblAudioMapping.getSelectedItem().toString().equals("Mix"))
					{
						if (grpSetAudio.getHeight() != 91)
							UIController.extendSections(grpSetAudio, 91);
	...
	private void grpCrop() {
		...
		grpCrop.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpCrop, 90);
			}
		...
		cropLock = new JLabel(new FlatSVGIcon("resources/unlock.svg", 16, 16));
		...
		cropLock.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (cropIsLocked) {
					cropLock.setIcon(new FlatSVGIcon("resources/unlock.svg", 16, 16));
					cropIsLocked = false;
					cropLock.setName("cropUnlock");
				} else {
					cropLock.setIcon(new FlatSVGIcon("resources/lock.svg", 16, 16));
					cropIsLocked = true;
	...
	private void grpOverlay() {
		...
		grpOverlay.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpOverlay, 278);
			}
	...
	private void grpSubtitles() {
		...
		grpSubtitles.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpSubtitles, 131);
			}
	...
	private void grpWatermark() {
		...
		grpWatermark.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpWatermark, 113);
			}
	...
	private void grpColorimetry() {
		...
		grpColorimetry.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpColorimetry, 165);
			}
	...
	private void grpImageAdjustement() {
		...
		grpImageAdjustement.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpImageAdjustement, 792);
			}
	...
	private void grpCorrections() {
		...
		grpCorrections.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpCorrections, size);
			}
	...
	private void grpTransitions() {
		...
		grpTransitions.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpTransitions, 104);
			}
	...
	private void grpImageSequence() {
		...
		grpImageSequence.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpImageSequence, 93);
			}
	...
	private void grpAdvanced() {
		...
		grpAdvanced.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				UIController.extendSections(grpAdvanced, size);
			}
		...
		caseCreateTree.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (caseCreateTree.isSelected()) {
					UIController.setDestinationTabs(2);
					...
					if (caseCreateOPATOM.isSelected() == false) {
						if (comboFonctions.getSelectedItem().toString().equals("H.264")) {
							UIController.setDestinationTabs(6);
						} else
							UIController.setDestinationTabs(5);
					}
	...
	private void grpBitrate() {
		...
		lock = new JLabel(new FlatSVGIcon("resources/unlock.svg", 16, 16));
		lock.setName("unlock");
		...
		lock.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (isLocked) {
					lock.setIcon(new FlatSVGIcon("resources/unlock.svg", 16, 16));
					isLocked = false;
					lock.setName("unlock");
				} else {
					lock.setIcon(new FlatSVGIcon("resources/lock.svg", 16, 16));
					isLocked = true;
					lock.setName("lock");
				}
	...
	private void StatusBar() {
		...
		statusBar.addMouseMotionListener(new MouseMotionListener() {
			...
			public void mouseDragged(MouseEvent e) {
				...
				if (windowDrag) {
					UIController.resizeAll(width, i);
				}
		...
		lblYears.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (System.getProperty("os.name").contains("Mac") == false)
					oldVersions.setIconImage(new ImageIcon(getClass().getClassLoader().getResource("resources/icon.png")).getImage());
				...
				JLabel image = new JLabel(
						new ImageIcon(getClass().getClassLoader().getResource("resources/2013-2016.jpg")));
